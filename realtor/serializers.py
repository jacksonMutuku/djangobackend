...
class ForSaleSerializer(serializers.ModelSerializer):
    class Meta:
        model = ForSale
        fields= '__all__'
        extra_kwargs = {'std_code': {'required': False},'uni_code': {'required': False},'price': {'required': False},'location': {'required': False},'description': {'required': False},'housetype': {'required': False}}
